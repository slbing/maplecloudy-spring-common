...
import com.maplecloudy.common.constant.CommonConstant;
...
public class JsonUtil {
  ...
  static {
    ...
    // 允许不带引号的字段名称
    MAPPER.configure(JsonReadFeature.ALLOW_UNQUOTED_FIELD_NAMES.mappedFeature(),
        true);
    // 允许单引号
   ...
   *          泛型对象
   */
  public static <T> T toObject(String json, Class<?> parametrized,
